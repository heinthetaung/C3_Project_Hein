...
class RestaurantTest {
    ...
    public void is_restaurant_open_should_return_true_if_time_is_between_opening_and_closing_time(){
        ...
        LocalTime mockTime = restaurant.openingTime.plusSeconds(30);
    ...
    public void is_restaurant_open_should_return_false_if_time_is_outside_opening_and_closing_time(){
        Restaurant spyRestaurant = Mockito.spy(restaurant);
        LocalTime mockTime = restaurant.openingTime.minusSeconds(30);
        Mockito.when(spyRestaurant.getCurrentTime()).thenReturn(mockTime);
    ...
    @Test
    public void passing_items_price_119_and_269_should_return_total_price_388() {
        ...
        assertEquals(388, restaurant.calculateTotalPrice(selectedItemNames));
    }
    //<<<<<<<<<<<<<<<<<<<<<<<MENU>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
}